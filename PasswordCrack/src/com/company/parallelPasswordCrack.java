...
public class parallelPasswordCrack {
    public List<String> list = new CopyOnWriteArrayList<>();
    public synchronized void decrementList(String password) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        parallelPasswordCrack test = new parallelPasswordCrack();
        test.store(pass);
        test.hashing(dic);
